...
It includes the flow for submitting a model and running an evaluation.
...
flowchart TD
  ...
  subgraph S[System]
    ...
    s14["Create<br/>evaluation job"]
    s15["Queue job"]
    s16["Run containerized<br/>evaluation"]
    s17["Compute metrics"]
    s18["Persist results"]
    s19["Update<br/>Leaderboard"]
    s20["Notify team"]
  end
  ...
  s13 -->|No| p13
  s13 -->|Yes| o9 --> p13 --> s14 --> s15 --> s16 --> s17 --> s18 --> s19 --> s20 --> end2([End])
  ...
  class p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13 participant;
  class s1,s2,s3,s4,s6,s7,s10,s11,s14,s15,s16,s17,s18,s19,s20 system;
